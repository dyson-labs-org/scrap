...
**Default: secp256k1** for all SISL operations. This maintains a single key hierarchy shared with SCAP (payment layer) and onion routing.
...
**P-256 alternative**: If FIPS 140-2/3 compliance is required, P-256 may be used for SISL X3DH only. This requires a separate key hierarchy from SCAP/Lightning. See [SCAP.md §11.1](SCAP.md#111-elliptic-curve-selection) for detailed guidance.
