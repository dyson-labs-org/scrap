...
**Entity Definitions**: See PROPOSAL_PTLC.md "Entity Definitions" section for the complete glossary of terms including Customer, Satellite, Operator, Gateway, Ground Station, and Watchtower. This document uses consistent terminology.
...
│    Same cryptography as PROPOSAL_PTLC.md, just in channels not on-chain     │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                             │
│  UNIFIED ADAPTOR CONVENTION (same as PROPOSAL_PTLC.md):                     │
│  ──────────────────────────────────────────────────────                     │
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  SYSTEM 1: ON-CHAIN PTLCs (PROPOSAL_PTLC.md)                                │
│  ───────────────────────────────────────────                                │
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  UNIFIED INFRASTRUCTURE: See PROPOSAL_PTLC.md Section 14 for the complete   │
...
│                                                                             │
│  ROOT KEY (same as PROPOSAL_PTLC.md):                                       │
│  ─────────────────────────────────────                                      │
...
│  ────────────────────────────────────                                       │
│    On-chain PTLC model (PROPOSAL_PTLC.md):                                  │
...
│  OPERATOR RECOVERY:                                                         │
│  ──────────────────                                                         │
│    Same recovery mechanism as PROPOSAL_PTLC.md:                             │
...
│      - Operator can claim after 6-month CLTV (see PROPOSAL_PTLC.md)         │
...
This document describes Phase 2 of the satellite payment system. For a smooth upgrade from Phase 1 (on-chain PTLCs), see PROPOSAL_PTLC.md Section 14-15 for the unified infrastructure and upgrade path documentation.

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    RELATIONSHIP TO PROPOSAL_PTLC.md                         │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  PHASE 1 (PROPOSAL_PTLC.md): On-Chain PTLCs                                 │
│  ───────────────────────────────────────────                                │
...
│                                                                             │
│  UNIFIED INFRASTRUCTURE (PROPOSAL_PTLC.md Section 14):                      │
│  ─────────────────────────────────────────────────────                      │
